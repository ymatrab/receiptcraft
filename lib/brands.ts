...
export const BRAND_TEMPLATES: ReceiptTemplate[] = [
  ...
  },
  {
    ...
    defaults: {
      ...
      businessName: "Zara",
      addressLine1: "128 Madison Avenue",
      ...
      itemStyle: "lined",
      showCardAuth: true,
      manager: "STORE MGR: Jessica Harth",
      policyText:
        "Items may be returned or exchanged within 14 days of purchase. Merchandise must be in original condition, in its original packaging with tags attached, and accompanied by a valid proof of purchase. Refunds are issued to the original payment method.",
      paperStyle: "modern",
      items: [
        { id: id(), name: "Silk Evening Gown", quantity: 1, price: 2450.0 },
        { id: id(), name: "Leather Handbag", quantity: 1, price: 1820.0 },
        { id: id(), name: "Cashmere Scarf", quantity: 2, price: 560.0 },
      ],
    },
  },
  {
