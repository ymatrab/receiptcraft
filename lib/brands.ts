...
export const BRAND_TEMPLATES: ReceiptTemplate[] = [
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 7.5,
      register: "REG #06",
      cashier: "Cashier: Beth",
      footerMessage: "Fresh For Everyone. Fuel Pts: 142",
      paperStyle: "thermal",
      items: [
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 7.5,
      register: "REG #14",
      cashier: "Cashier: Maria",
      footerMessage: "Where Shopping Is A Pleasure.",
      paperStyle: "thermal",
      items: [
        { id: id(), name: "Pub Sub Ultimate (Whole)", quantity: 1, price: 9.99 },
        { id: id(), name: "Publix Deli Fried Chicken 8pc", quantity: 1, price: 8.99 },
        { id: id(), name: "GreenWise Org Milk 1/2 Gal", quantity: 1, price: 4.99 },
        { id: id(), name: "BOGO Chips Ahoy 13oz", quantity: 1, price: 4.49 },
      ],
    },
  },
  {
    ...
    defaults: {
      ...
      taxRate: 9.25,
      register: "REG #11",
      cashier: "Cashier: Dave",
      footerMessage: "Club Card Savings: $4.72 — Thank You!",
      paperStyle: "thermal",
      items: [
        { id: id(), name: "O Org Whole Milk Gal", quantity: 1, price: 5.99 },
        { id: id(), name: "Signature Sel Pasta 16oz", quantity: 2, price: 1.99 },
        { id: id(), name: "Fresh Atlantic Salmon (lb)", quantity: 0.8, price: 11.99 },
        { id: id(), name: "Waterloo Sparkling Water 12pk", quantity: 1, price: 5.99 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 7.875,
      register: "REG #05",
      cashier: "Advisor: Chris",
      footerMessage: "Let's Talk About What's Possible.",
      paperStyle: "thermal",
      items: [
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 8.875,
      register: "REG #32",
      cashier: "Associate: Lisa",
      footerMessage: "Star Rewards Member — Way To Shop!",
      paperStyle: "thermal",
      items: [
        { id: id(), name: "Calvin Klein Dress Shirt", quantity: 1, price: 49.99 },
        { id: id(), name: "Charter Club Cashmere Sweater", quantity: 1, price: 79.50 },
        { id: id(), name: "Hotel Collection Bath Towel", quantity: 2, price: 18.0 },
      ],
    },
  },
  {
    ...
    defaults: {
      ...
      taxRate: 10.25,
      register: "REG #04",
      cashier: "Stylist: Rachel",
      footerMessage: "Nordy Club Pts Earned: 3x — Thank You!",
      paperStyle: "modern",
      items: [
        { id: id(), name: "Nike Pegasus 41 Running Shoe", quantity: 1, price: 130.0 },
        { id: id(), name: "Zella High-Waist Leggings", quantity: 1, price: 59.0 },
        { id: id(), name: "Kiehl's Ultra Facial Cream", quantity: 1, price: 33.0 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxLabel: "Est. Tax",
      taxRate: 10.1,
      footerMessage: "Thank you for your Amazon order!",
      paperStyle: "modern",
      items: [
        { id: id(), name: "Anker USB-C Hub 7-in-1", quantity: 1, price: 35.99 },
        { id: id(), name: "Amazon Basics Mouse Pad", quantity: 1, price: 8.99 },
        { id: id(), name: "Shipping & Handling", quantity: 1, price: 0.0 },
      ],
    },
  },
  {
    ...
    defaults: {
      ...
      taxLabel: "Sales Tax",
      taxRate: 9.25,
      footerMessage: "Thanks for buying on eBay!",
      paperStyle: "modern",
      items: [
        { id: id(), name: "Vintage Vinyl Record LP", quantity: 1, price: 24.99 },
        { id: id(), name: "Shipping (USPS Priority)", quantity: 1, price: 7.95 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxLabel: "Tax",
      taxRate: 0,
      footerMessage: "Billed by Apple — apple.com/bill",
      paperStyle: "minimal",
      items: [
        { id: id(), name: "Apple One Individual", quantity: 1, price: 19.95 },
        { id: id(), name: "iCloud+ 200GB", quantity: 1, price: 2.99 },
      ],
    },
  },
  {
    ...
    defaults: {
      ...
      taxLabel: "Tax",
      taxRate: 9.25,
      footerMessage: "Thank you for your Google Play purchase.",
      paperStyle: "minimal",
      items: [
        { id: id(), name: "YouTube Premium Monthly", quantity: 1, price: 13.99 },
        { id: id(), name: "Google One 100GB", quantity: 1, price: 1.99 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxLabel: "Tax",
      taxRate: 9.25,
      footerMessage: "Creativity for all.",
      paperStyle: "minimal",
      items: [
        { id: id(), name: "Creative Cloud All Apps (Annual/mo)", quantity: 1, price: 59.99 },
        { id: id(), name: "Adobe Stock 10 Assets", quantity: 1, price: 29.99 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 0,
      tip: 4.0,
      cashier: "Driver: Amanda R.",
      footerMessage: "Thanks for riding with Lyft!",
      paperStyle: "minimal",
      items: [
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 8.625,
      tip: 6.0,
      cashier: "Dasher: Kevin L.",
      footerMessage: "Your door to more.",
      paperStyle: "minimal",
      items: [
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 10.25,
      tip: 4.50,
      cashier: "Driver: Marco P.",
      footerMessage: "Hungry? You know what to do.",
      paperStyle: "minimal",
      items: [
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 9.5,
      tip: 5.00,
      cashier: "Courier: Nina T.",
      footerMessage: "Anything, anytime, anywhere.",
      paperStyle: "minimal",
      items: [
        { id: id(), name: "Harvest Bowl", quantity: 1, price: 14.95 },
        { id: id(), name: "Guacamole Greens Salad", quantity: 1, price: 13.45 },
        { id: id(), name: "Delivery Fee", quantity: 1, price: 1.99 },
        { id: id(), name: "Service Fee", quantity: 1, price: 3.50 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxLabel: "Tax",
      taxRate: 8.25,
      register: "Store #12847",
      footerMessage: "Oh Thank Heaven for 7-Eleven!",
      paperStyle: "thermal",
      items: [
        { id: id(), name: "Lg Slurpee Coca-Cola", quantity: 1, price: 2.19 },
        { id: id(), name: "Big Bite Hot Dog", quantity: 1, price: 2.49 },
        { id: id(), name: "Doritos Nacho 3oz", quantity: 1, price: 2.99 },
        { id: id(), name: "Reg Unleaded 10.5 Gal", quantity: 1, price: 35.49 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 8.25,
      register: "Pump #04",
      footerMessage: "BP — Fuel For Better Journeys.",
      paperStyle: "thermal",
      items: [
        { id: id(), name: "Regular 87 Oct 11.6 Gal", quantity: 1, price: 38.28 },
        { id: id(), name: "ampm Hot Dog Combo", quantity: 1, price: 3.49 },
        { id: id(), name: "Monster Energy 16oz", quantity: 1, price: 3.49 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 8.517,
      register: "Pump #10",
      footerMessage: "QT — Always Open. Always Clean.",
      paperStyle: "thermal",
      items: [
        { id: id(), name: "Regular 87 Oct 13.5 Gal", quantity: 1, price: 39.83 },
        { id: id(), name: "QT Kitchen Breakfast Burrito", quantity: 1, price: 3.29 },
        { id: id(), name: "QT Big-Q Fountain 32oz", quantity: 1, price: 1.09 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      taxRate: 8.875,
      register: "REG #08",
      footerMessage: "30 Day Return Policy — Keep Your Receipt.",
      paperStyle: "modern",
      items: [
        { id: id(), name: "Linen Blend Blazer", quantity: 1, price: 89.90 },
        { id: id(), name: "Flowing Midi Skirt", quantity: 1, price: 45.90 },
        { id: id(), name: "Minimalist Leather Belt", quantity: 1, price: 25.90 },
      ],
    },
  },
  {
