...
const field = "w-full rounded-[3px] border border-rule px-3 py-2 text-sm focus:border-ledger/45 focus:outline-none";
...
export default async function AdminSettings() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      {/* AI provider */}
      <section className="mt-6 rounded-[3px] border border-rule bg-card p-6">
        <h2 className="text-lg font-semibold text-ink">AI receipt generator</h2>
        ...
        <form action={saveAiAction} className="mt-4 space-y-4">
          ...
          <button type="submit" className="rounded-full bg-ledger px-5 py-2.5 text-sm font-semibold text-white hover:bg-ledger-deep">
            Save AI settings
          </button>
        </form>
      </section>
      ...
      {/* Checkout links */}
      <section className="mt-6 rounded-[3px] border border-rule bg-card p-6">
        <h2 className="text-lg font-semibold text-ink">Checkout links</h2>
        <p className="mt-1 text-sm text-ink-soft">
