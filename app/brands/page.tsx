    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section id="faq" className="mt-20" aria-labelledby="brand-faq-heading">
        <div className="mx-auto max-w-3xl">
          <h2 id="brand-faq-heading" className="text-center text-3xl font-bold tracking-tight text-ink">
          ...
          <div className="mt-10 divide-y divide-rule rounded-[3px] border border-rule bg-card px-6">
            {BRAND_FAQS.map((faq) => (
              <details key={faq.question} className="group py-5">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-left font-medium text-ink [&::-webkit-details-marker]:hidden">
                  {faq.question}
                  <svg
                    className="h-5 w-5 shrink-0 text-ink-soft/70 transition-transform group-open:rotate-180"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
